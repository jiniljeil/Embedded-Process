...
#define MBED_CONF_APP_WIFI_PASSWORD                                           "netlab2@414"                                                                                    // set by application
#define MBED_CONF_APP_WIFI_RX                                                 PA_10                                                                                            // set by application
#define MBED_CONF_APP_WIFI_SHIELD                                             WIFI_ESP8266                                                                                     // set by application
#define MBED_CONF_APP_WIFI_SSID                                               "netlab2"                                                                                        // set by application
#define MBED_CONF_APP_WIFI_TX                                                 PA_9                                                                                             // set by application
